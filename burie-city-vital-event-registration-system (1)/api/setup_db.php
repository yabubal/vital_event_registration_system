...
try {
    ...
    // We already defined $dsn in db.php but it includes dbname which might not exist
    // So we use a generic connection to create DB
    ...
    CREATE TABLE IF NOT EXISTS users (
        ...
        PRIMARY KEY (user_id),
        UNIQUE KEY (username)
        -- Removed FK to kebeles to avoid issues if data missing
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
    ...
    CREATE TABLE IF NOT EXISTS vital_records (
        ...
        -- Removed FK constraints to avoid blocking insertion if user/kebele mismatch during dev
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
